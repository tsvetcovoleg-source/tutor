          ...
          <?php foreach ($messages as $row): ?>
            ...
            <article class="message-item">
              ...
              <?php if (is_array($evaluation)): ?>
                <div class="text-cell eval-cell" style="background:#fff7ed;border-color:#fed7aa;">English Quality: <?= e((string)($evaluation['english_quality'] ?? '-')) ?><br>Clarity &amp; Structure: <?= e((string)($evaluation['clarity_structure'] ?? '-')) ?><br>Risk &amp; Decision Thinking: <?= e((string)($evaluation['risk_decision_thinking'] ?? '-')) ?><br>Stakeholder Thinking: <?= e((string)($evaluation['stakeholder_thinking'] ?? '-')) ?><br>Overall: <?= e((string)($evaluation['overall_score'] ?? '-')) ?><br><br><?= nl2br(e((string)($evaluation['improvement_comment'] ?? ''))) ?><?php if (trim((string)($evaluation['ideal_answer_example'] ?? '')) !== ''): ?><br><br><strong>Ideal answer example:</strong><br><?= nl2br(e((string)$evaluation['ideal_answer_example'])) ?><?php endif; ?></div>
              <?php endif; ?>
